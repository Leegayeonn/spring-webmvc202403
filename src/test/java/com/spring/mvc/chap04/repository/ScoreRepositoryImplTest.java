...
class ScoreRepositoryImplTest {
    ...
    void saveTest() {
        ScoreRequestDTO dto = new ScoreRequestDTO("사범이", 100, 99, 98);
    ...
    @Test
    @DisplayName("tbl_score의 모든 학생 목록을 조회했을 떄 학생의 수는 4명일 것이다.")
    void findAllTest() {
        // given
    ...
    @Test
    @DisplayName("3번 학생의 이름은 비염범이일 것이다.")
    void findOneTest() {
        // given
        int stuNum = 3;
        // when
        ...
        // then
        assertEquals("비염범이", score.getName());
    }
