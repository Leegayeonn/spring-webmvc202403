...
<body>
        ...
        <script>
            ...
            document.getElementById('sendBtn').onclick = () => {
                const $area1 = document.querySelector('select[name=h_area1]');  // 속성선택자
                const $area2 = document.querySelector('select[name=h_area2]');  

                // value값은 숫자, 우리는 내용을 얻고싶기때문에 
                ...
                fetch(`/weather/api-req/\${value1}/\${value2}`)
            }
        ...
        cat2_num[15] = new Array(234);      
        cat2_name[15] = new Array('세종특별자치시'); 

        cat2_num[16] = new Array(235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249);
        cat2_name[16] = new Array('공주시', '논산시', '보령시', '서산시', '아산시', '천안시', '금산군', '당진군', '부여군', '서천군', '연기군', '예산군',
            '청양군', '태안군', '홍성군');
        cat2_num[17] = new Array(250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261);
        cat2_name[17] = new Array('제천시', '청주시 상당구', '청주시 흥덕구', '충주시', '괴산군', '단양군', '보은군', '영동군', '옥천군', '음성군', '진천군',
            '청원군');
