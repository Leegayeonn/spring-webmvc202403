...
public class CoffeeController {
    ...
    public String result(String menu,
                         // 사용자가 커피를 선택하지 않으면 이벤트가 발생하지않음 -> price 가 세팅이 안됨,
                         // -> price 가 ""로 전달됨. -> ""를 int 로 변환하는 과정에서 에러가 발생.
        ...
        return "chap03/coffee-result"; // view resolver 의 접두어, 접미어를 잘 고려하세요.
